...
if(!empty ($_POST))
{
    ...
    #Memanggil data yang dihantar dari fail singup-borang.php 
    $nama = $_POST['nama'];
    $nokp = $_POST['nokp'];
    ...
    # arahan SQL (query) untuk menyimpan data peserta baru 
    $arahan_sql_simpan = "insert into peserta
    (nokp, nama, id_sekolah, katalaluan, tahap)
    values
    ('$nokp', '$nama', '$id_sekolah', '$katalaluan', 'PESERTA BIASA') ";
    ...
    {
        #jika data berjaya disimpan. papar popup  dan buka fail peserta-login-borang

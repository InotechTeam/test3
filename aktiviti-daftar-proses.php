...
if(!empty($_POST))
{
    ...
    $laksanakan_arahan_simpan = mysqli_query($condb,$arahan_sql_simpan);

    #menguji jika proses menyimpan dataa berjaya atau tidak 
    if($laksanakan_arahan_simpan)
    ...
    {
        #jika data tidak berjaya disimpan. papar popup dan buka fail-daftar-borang
